...
},{"./transport":15,"./transports":16,"component-emitter":22,"debug":10,"engine.io-parser":23,"indexof":30,"parsejson":35,"parseqs":36,"parseuri":37}],15:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":9,"debug":10,"engine.io-parser":23,"parseqs":36,"xmlhttprequest-ssl":21,"yeast":50}],20:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":9,"debug":10,"engine.io-parser":23,"parseqs":36,"ws":6,"yeast":50}],21:[function(require,module,exports){
...
},{"./on":40,"./socket":41,"backo2":3,"component-bind":7,"component-emitter":8,"debug":10,"engine.io-client":12,"indexof":30,"socket.io-parser":44}],40:[function(require,module,exports){
...
},{"./on":40,"component-bind":7,"component-emitter":8,"debug":10,"has-binary":27,"socket.io-parser":44,"to-array":48}],42:[function(require,module,exports){
(function (global){
...
},{"debug":10,"parseuri":37}],43:[function(require,module,exports){
(function (global){
/*global Blob,File*/
...
},{"./binary":43,"./is-buffer":45,"component-emitter":46,"debug":10,"isarray":47,"json3":32}],45:[function(require,module,exports){
(function (global){
...
var stackHelper = require('../helpers/stackHelper');
var resultHelper = require('../helpers/resultHelper');
var navHelper = require('../helpers/navHelper');
var filterHelper = require('../helpers/filterHelper');
...
module.exports = function MainController() {
	...
	StackService.on('listUpdated', function (e, passed) {
		...
		if (!autoFocus || passed === false || passed === null) return;
...
},{"../helpers/filterHelper":52,"../helpers/navHelper":53,"../helpers/resultHelper":54,"../helpers/stackHelper":55,"../lib/config":58,"../services/FilterService":62,"../services/SocketService":63,"../services/StackService":64}],52:[function(require,module,exports){
'use strict';

var $ = require('jquery');
var _ = require('lodash');
var debug = require('debug')('marvel:viewHelper:filter');
...
},{"debug":10,"jquery":31,"lodash":33}],53:[function(require,module,exports){
'use strict';

var $ = require('jquery');

var $countTotal = void 0,
    $countVisible = void 0,
    $autoFocus = void 0,
    $sources = void 0;
...
},{"jquery":31}],54:[function(require,module,exports){
/*jshint -W030 */
...
var config = require('../lib/config');
var debug = require('debug')('marvel:viewHelper:result');
...
},{"../lib/config":58,"../lib/pretty":61,"debug":10,"jquery":31}],55:[function(require,module,exports){
'use strict';

var $ = require('jquery');
var _ = require('lodash');

var debug = require('debug')('marvel:viewHelper:stack');
var FilterService = require('../services/FilterService');
var config = require('../lib/config');
...
function loadColumns() {
	...
	//Default columns
	if (config._sources.length > 1) trs.unshift({ name: 'source' });
...
exports.updateErrorState = function (msg) {
	...
	if (msg) $('section.list>.error').text(msg);
};
...
function stackTemplate(stack) {
	...
	if (config._sources.length > 1) str += '<td>' + (stack.source || '') + '</td>';
	...
	for (var i = 0; i < cols.length; i++) {
		...
		//Apply formatter
		if (cols[i].formatter) val = cols[i].formatter(val);
...
},{"../lib/config":58,"../services/FilterService":62,"debug":10,"jquery":31,"lodash":33}],56:[function(require,module,exports){
/* globals document */
'use strict';

var debug = require('debug')('marvel:main');
debug('init');
...
},{"./controllers/MainController":51,"./lib/config":58,"./lib/flash-plugin":59,"./services/SocketService":63,"./services/StackService":64,"debug":10,"jquery":31}],57:[function(require,module,exports){
'use strict';
...
},{"jquery":31}],58:[function(require,module,exports){
'use strict';
...
function setTypes() {
	...
	_.each(self.types, function (item) {
		if (_.isPlainObject(item.glue)) self._typeGlues[item.name] = [item.glue];
		if (_.isArray(item.glue)) self._typeGlues[item.name] = item.glue;
	});
}
...
},{"../lib/formatters":60,"jquery":31,"lodash":33}],59:[function(require,module,exports){
'use strict';
...
},{"jquery":31}],60:[function(require,module,exports){
'use strict';
...
var jsonFormat = {
    replacer: function replacer(match, pIndent, pKey, pVal, pStart, pEnd, comma) {
        var r = pIndent || '';
    ...
    prettyPrint: function prettyPrint(obj) {
        ...
        return JSON.stringify(obj, null, 3).replace(/&/g, '&amp;').replace(/\\"/g, '&quot;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(jsonLine, jsonFormat.replacer);
    }
};
...
var debug = require('debug')('marvel:filter');

var _ = require('lodash');
var EventEmitter = require('../lib/EventEmitter');

var PROP_REGEX = /\{([\.\w-\[\]]+)\}/g;
var OWN_PROPS = ['id', 'created', 'source'];

var FilterService = function (_EventEmitter) {
    _inherits(FilterService, _EventEmitter);

    function FilterService() {
        _classCallCheck(this, FilterService);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FilterService).call(this));

        _this.query = '';
        _this.lastQuery = null;
        _this.evalError = '';
        try {
            _this.query = window.sessionStorage.getItem('query') || '';
        } catch (e) {}
        return _this;
    }
    ...
    _createClass(FilterService, [{
        ...
        key: 'add',
        value: function add(prop, value, query) {
        ...
        key: 'checkStack',
        value: function checkStack(stack) {
            this.evalError = '';
...
},{"../lib/EventEmitter":57,"debug":10,"lodash":33}],63:[function(require,module,exports){
'use strict';
...
var debug = require('debug')('marvel:socket');
...
var SocketConnection = function (_EventEmitter) {
    _inherits(SocketConnection, _EventEmitter);

    function SocketConnection(name, uri) {
        _classCallCheck(this, SocketConnection);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SocketConnection).call(this));

        _this.name = name;
        _this.uri = uri;
        _this.debug = require('debug')('marvel:socket:' + name);
        _this.socket = null;
    ...
    _createClass(SocketConnection, [{
        ...
        value: function connect() {
            ...
            this.socket.on('connect', function () {
                ...
                _this2.emit('statusChanged', true);

                _this2.socket.emit('getMetadata', function (meta) {
                    _this2.meta = meta;
                });
            });
            this.socket.on('disconnect', function () {
                _this2.connected = false;
                _this2.emit('statusChanged', false);
            });
            ...
            this.socket.on('log', function (log) {
                ...
                // this.debug('log',log)
                StackService.addLog(_this2.name, log);
            });
            this.socket.on('logs', function (logs) {
                if (_this2.paused) return;
                _this2.debug('logs', logs.length);
                StackService.addLogs(_this2.name, logs);
            });
        }
    }, {
        key: 'togglePause',
        ...
        key: 'fetchHistory',
        value: function fetchHistory(num, step) {
            this.debug('fetchHistory asking', num, step);
            this.socket.emit('fetchHistory', { num: num, step: step });
        }
    }, {
        key: 'debugEvents',
        value: function debugEvents() {
            var _this3 = this;

            //Socket events
            var eventNames = ['connect', 'error', 'disconnect', 'reconnect',
            // 'reconnect_attempt',
            'reconnecting'];
            ...
            eventNames.forEach(function (eventName) {
                _this3.socket.on(eventName, function () {
                    return _this3.debug('io:' + eventName);
                });
            });
        }
    }]);
...
var SocketsWrapper = function (_EventEmitter2) {
    _inherits(SocketsWrapper, _EventEmitter2);

    function SocketsWrapper() {
        _classCallCheck(this, SocketsWrapper);

        var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(SocketsWrapper).call(this));

        _this4.conns = [];

        debug('sources', config._sources);
        _.each(config._sources, function (source) {
            var conn = new SocketConnection(source.name, source.uri);
            _this4.conns.push(conn);
            conn.on('statusChanged', _this4._emitConnectionsStatus.bind(_this4));
            _this4._emitConnectionsStatus();
        });
        return _this4;
    }

    _createClass(SocketsWrapper, [{
        key: 'fetchHistory',
        value: function fetchHistory(num, step) {
        ...
        key: '_emitConnectionsStatus',
        value: function _emitConnectionsStatus() {
            this.emit('connectionsStatusChanged', [this.getConnections()]);
        }
    }, {
        key: 'togglePause',
        value: function togglePause(sourceName) {
    ...
    return SocketsWrapper;
}(EventEmitter);

module.exports = new SocketsWrapper();

},{"../lib/EventEmitter":57,"../lib/config":58,"./StackService":64,"debug":10,"lodash":33,"socket.io-client":38}],64:[function(require,module,exports){
/* globals window */
'use strict';
...
var debug = require('debug')('marvel:stack');
...
var StackService = function (_EventEmitter) {
    _inherits(StackService, _EventEmitter);

    function StackService() {
        _classCallCheck(this, StackService);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(StackService).call(this));

        _this.lastId = 0;
        _this.storageKey = 'stackList_cache_' + config._config_name;
        return _this;
    }
    ...
    _createClass(StackService, [{
        ...
        key: 'printList',
        value: function printList(noSave) {
            debug('printList');
            this.filterList();
            debug('filtered');
        ...
        value: function findStackById(id) {
            for (var i = this.list.length; i--; i) {
                if (this.list[i] && this.list[i].id == id) return this.list[i];
            }
            return null;
        }
        ...
        key: 'findStackInViewList',
        value: function findStackInViewList(id) {
            for (var i = this.viewList.length; i--; i) {
                if (this.viewList[i] && this.viewList[i].id == id) return i;
            }
            return -1;
        }
        ...
        key: 'findStackInList',
        value: function findStackInList(id) {
            for (var i = this.list.length; i--; i) {
        ...
        key: 'addLogs',
        value: function addLogs(source, logs) {
            // this.clearList();
            if (!logs) return;
        ...
        key: 'addLog',
        value: function addLog(source, log, fast) {
            //Check type validity
        ...
        key: '_updateStack',
        value: function _updateStack(stack) {
            //Viewlist add
            var index = this.findStackInViewList(stack.id);
            if (! ~index) this.viewList.push(stack);
        ...
        key: '_removeStack',
        value: function _removeStack(stack, alsoList) {
            //Viewlist remove
            var index = this.findStackInViewList(stack.id);
            if (~index) this.viewList.splice(index, 1);
        ...
        key: '_applyLogToStack',
        value: function _applyLogToStack(source, log) {
        ...
        key: '_createStack',
        value: function _createStack(source) {
        ...
        key: '_mergeStacks',
        value: function _mergeStacks(stacks) {
        ...
        key: '_findStacksByGlue',
        value: function _findStacksByGlue(_ref) {
            var type = _ref.type;
            var body = _ref.body;
...
},{"../lib/EventEmitter":57,"../lib/config":58,"./FilterService":62,"debug":10,"lodash":33}]},{},[56])
